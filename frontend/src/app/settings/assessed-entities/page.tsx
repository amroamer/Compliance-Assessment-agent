                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-4"><div className="flex items-center justify-end gap-1">
                        ...
                        <button onClick={async (e2) => { e2.stopPropagation(); router.push(`/settings/assessed-entities/${e.id}/departments`); }} className="p-2 text-kpmg-placeholder hover:text-kpmg-navy rounded-btn transition" title="Departments"><Building2 className="w-4 h-4" /></button>
      ...
      <ImportPreviewModal open={!!importPreview} preview={importPreview} loading={importing} itemLabel="entities" nameKey="name"
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            toast(`Imported ${d.imported} entities (${d.skipped_duplicates} skipped)`, "success"); queryClient.invalidateQueries({ queryKey: ["assessed-entities"] });
