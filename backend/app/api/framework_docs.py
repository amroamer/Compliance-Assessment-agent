...
async def export_nodes_excel(fw_id: uuid.UUID, db: AsyncSession = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    ws = wb.active
    ws.title = "Hierarchy"
    headers = ["reference_code", "name", "name_ar", "node_type", "parent_reference_code", "description", "description_ar", "guidance", "guidance_ar", "is_assessable", "weight", "sort_order", "maturity_level", "evidence_type", "acceptance_criteria", "acceptance_criteria_en", "spec_references", "priority"]
    ...
    for row_idx, n in enumerate(nodes, 2):
        ...
        vals = [n.reference_code, n.name, n.name_ar, n.node_type, parent_ref, n.description, n.description_ar, n.guidance, n.guidance_ar, n.is_assessable, float(n.weight) if n.weight else None, n.sort_order, n.maturity_level, n.evidence_type, n.acceptance_criteria, n.acceptance_criteria_en, n.spec_references, n.priority]
